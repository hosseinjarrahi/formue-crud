  ...
  <div class="fm-header">
    <v-tooltip location="bottom" text="add">
      <template v-slot:activator="{ props }">
        <button v-bind="props" class="fm-header-icon-btn group" @click="event('createBtn')">
    ...
    <div class="fm-header-Separator"></div>
    <v-tooltip location="bottom" text="reload">
      <template v-slot:activator="{ props }">
        <button v-bind="props" class="fm-header-icon-btn group" @click="store.reloadData">
          <svg
    ...
    <v-tooltip location="bottom" text="pdf">
      <template v-slot:activator="{ props }">
        <button v-bind="props" class="fm-header-icon-btn group" @click="event('createBtn')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
    ...
    <v-tooltip location="bottom" text="excel">
      <template v-slot:activator="{ props }">
        <button v-bind="props" class="fm-header-icon-btn group" @click="event('createBtn')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
    ...
    <v-tooltip location="bottom" text="print">
      <template v-slot:activator="{ props }">
        <button v-bind="props" class="fm-header-icon-btn group" @click="event('createBtn')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path
    ...
    <v-tooltip location="bottom" text="filter">
      <template v-slot:activator="{ props }">
        <button v-bind="props" class="fm-header-icon-btn group" @click="event('showFilter')">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
            <path

  ...
  <div class="fm-header !flex-row-reverse rtl:test">
    <div class="fm-header-left-sid flex-row-reverse">
      ...
      <v-tooltip location="bottom" :text="$fcTr('select_row')">
        <template v-slot:activator="{ props }">
          <button v-bind="props" class="fm-header-icon-btn" :class="{ 'fm-active-btn': isSelectActive }"
            @click="toggleSelect">
        ...
        <template v-slot:activator="{ props: menu }">
          <v-tooltip location="bottom">
            <template v-slot:activator="{ props: tooltip }">
              <button v-bind="{ ...menu, ...tooltip }" class="fm-header-icon-btn" :class="[
        ...
        <div class="bg-white rounded-xl rtl:text-right ltr:text-left fm-light-shadow">
          ...
          <ul class="p-2">
            <template v-for="field in store.flatFieldsWithoutActions" :key="field.field">
              <SelectColumnItem :column-name="field.title" :checked="field.isHeader"
